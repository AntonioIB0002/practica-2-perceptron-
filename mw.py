...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lineEdit_presicion = QtWidgets.QLineEdit(self.groupBox_2)
        self.lineEdit_presicion.setReadOnly(True)
        self.lineEdit_presicion.setObjectName("lineEdit_presicion")
        self.verticalLayout.addWidget(self.lineEdit_presicion)
        self.label_8 = QtWidgets.QLabel(self.groupBox_2)
        self.label_8.setObjectName("label_8")
        self.verticalLayout.addWidget(self.label_8)
        self.lineEdit_Matrizconfu = QtWidgets.QLineEdit(self.groupBox_2)
        self.lineEdit_Matrizconfu.setReadOnly(True)
        self.lineEdit_Matrizconfu.setObjectName("lineEdit_Matrizconfu")
        self.verticalLayout.addWidget(self.lineEdit_Matrizconfu)
        self.label_9 = QtWidgets.QLabel(self.groupBox_2)
        self.label_9.setObjectName("label_9")
        self.verticalLayout.addWidget(self.label_9)
        self.lineEdit_f1score = QtWidgets.QLineEdit(self.groupBox_2)
        self.lineEdit_f1score.setReadOnly(True)
        self.lineEdit_f1score.setObjectName("lineEdit_f1score")
        self.verticalLayout.addWidget(self.lineEdit_f1score)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_7.setText(_translate("MainWindow", "Presicion"))
        self.label_8.setText(_translate("MainWindow", "Matriz de confusion"))
        self.label_9.setText(_translate("MainWindow", "f1_score"))
